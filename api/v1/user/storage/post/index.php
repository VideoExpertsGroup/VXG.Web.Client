...
list($storage, $endpoint, $name, $access_key, $secret_key, $upload_sqs_name, $upload_sqs_region) 
    = MCore::checkAndGetInputParameters(['storage', 'endpoint', 'name', 'access_key', 'secret_key', 'upload_sqs_name', 'upload_sqs_region']);
...
curl_setopt_array($curl, [CURLOPT_SSL_VERIFYPEER => false, CURLOPT_SSL_VERIFYHOST => false, CURLOPT_POST => true, 
        CURLOPT_POSTFIELDS => $data, CURLOPT_RETURNTRANSFER => true, CURLOPT_HEADER => false, CURLOPT_CUSTOMREQUEST => 'POST',
