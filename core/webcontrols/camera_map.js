...
//        this.cameraClickCallback = '';
    ...
    sortCameras: function (data) {
        let locations = [];
let c = getComputedStyle(document.documentElement).getPropertyValue('--main-color');

let ic = btoa('<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="15" cy="14.9477" rx="15" ry="14.9128" fill="'+c+'" fill-opacity="0.5"/>' +
'<ellipse cx="15" cy="14.9478" rx="11" ry="10.936" fill="'+c+'"/><path d="M17.9167 14.125V12.0833C17.9167 11.7625 17.6542 11.5 17.3333 11.5H10.3333C10.0125 11.5 9.75 11.7625 9.75 12.0833V17.9167C9.75 18.2375 10.0125 18.5 10.3333 18.5H17.3333C17.6542 18.5 17.9167 18.2375 17.9167 17.9167V15.875L19.2525 17.2108C19.62 17.5783 20.25 17.3158 20.25 16.7967V13.1975C20.25 12.6783 19.62 12.4158 19.2525 12.7833L17.9167 14.125Z" fill="white"/></svg>');
...
ClusterIcon.prototype.show = function () {
  if (this.div_) {
    ...
    img = "<svg width='30' height='30' viewBox='0 0 30 30' fill='none' xmlns='http://www.w3.org/2000/svg' style='position: absolute; top: " + spriteV + "px; left: " + spriteH + "px; ";
    ...
    img += '\'><ellipse cx="15" cy="14.9477" rx="15" ry="14.9128" fill="var(--main-color)" fill-opacity="0.5"/><ellipse cx="15" cy="14.9477" rx="11" ry="10.936" fill="var(--main-color)"/></svg>';
...
// =====================================================================================================
class CCameraMap extends HTMLElement {
    ...
    dynamicLoadGoogleMap = function(){
        let load_promise = $.Deferred();

        let scripts = document.getElementsByTagName('script');
        for (let i=0; i<scripts.length;i++){
            if (scripts[i].src.indexOf('https://maps.googleapis.com/maps/api/js')===-1) continue;
            setTimeout(function(){load_promise.resolve()});
            return load_promise;
        }
...
//        script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyC0L42SfFlCgWi15F75bky6yQ6I6FPkeCA'; // debug
    ...
    connectedCallback() {
        ...
        this.dynamicLoadGoogleMap().then(function(){
...
.preview-container.img.empty{background-image: url(data:image/svg+xml;base64,);}
...
window.customElements.define('camera-map', CCameraMap);
