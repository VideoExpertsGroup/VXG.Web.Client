...
window.screens['bottomline'] = {
    'on_ready':function(){
        ...
        core.elements['global-menu-footer'].append('<div class="bottomline font-sm" style="line-height: 7px;font-size: 10px;;color: black;text-align: right;padding: 7px 7px;">'+t+'</div>');
    }
};
