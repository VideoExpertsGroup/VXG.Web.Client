    ...
    'on_init': function () {
        ...
        this.play = function () {
            if (window.controls['player'].players['player' + this.newid] !== undefined) {
                window.controls['player'].players['player' + this.newid].play();
            }
        };
        this.stop = function () {
            if (window.controls['player'].players['player' + this.newid] !== undefined) {
        ...
        var playerOptions = {
            timeline: ($(this).attr('timeline') !== undefined),
            timelineampm: true,
            mute: true,
            alt_protocol_names: true,
            calendar: false,
            autohide: ($(this).attr('autohide') === undefined ? -1 : 3000)
        };
        ...
        if (window.screens['cameras'].playerList) {
            window.screens['cameras'].playerList.addPlayerToList(window.controls['player'].players['player' + this.newid]);
        }
